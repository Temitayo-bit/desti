 ...
 *
 * Transitions a match from SUGGESTED -> REJECTED for the trip request owner.
 */
export async function POST(
    ...
    try {
        ...
        const item = await rejectMatch(matchId, auth.user.clerkUserId);
        ...
        console.error("[POST /api/matches/:matchId/reject] Unexpected error:", error);
        return NextResponse.json(
            {
