...
type ProtectedNavKey = "browse" | "postRide";
      ...
      >
        <div className="p-6 h-full flex flex-col">
          ...
          <nav className="flex-1 space-y-2">
            <Link
              href="#"
              className="flex items-center gap-3 px-4 py-3 text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100/80 rounded-xl font-medium transition-colors pointer-events-none opacity-60"
            >
            ...
            <Link href="/" className={navLinkClass(activeNav === "browse")}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
