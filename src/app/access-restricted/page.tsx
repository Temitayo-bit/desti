...
export default async function AccessRestrictedPage({
  ...
  const reason: RestrictionReason = isKnownReason
    ? rawReason
    : "missing_email";
    ...
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center gap-6 px-6 py-20">
      <section className="rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-6 text-zinc-600">
          This app requires a verified <strong>@stetson.edu</strong> email
          address.
        </p>

        <p className="mt-2 text-sm leading-6 text-zinc-600">{reasonCopy}</p>
